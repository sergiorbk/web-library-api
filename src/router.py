...
from src.api.v1.routers.client_router import router as client_router_v1
from src.api.v1.routers.checkout_router import router as checkout_router_v1
...
def init_api_routers(app: FastAPI):
    ...
    app.include_router(checkout_router_v1)